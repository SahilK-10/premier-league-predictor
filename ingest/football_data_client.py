...
Fetch Premier League match data from football-data.org and store it
...
class FootballDataClient:
    """Client for football-data.org Premier League match ingestion."""
    ...
    def fetch_matches(
        ...
        """
        url = f"{FOOTBALL_DATA_BASE_URL}/competitions/{PREMIER_LEAGUE_CODE}/matches"
        ...
        logger.info("Fetching Premier League matches with params=%s", params)
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Ingest Premier League matches from football-data.org."
    )
